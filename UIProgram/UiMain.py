...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "计科224李享哲-基于yolov8改进网络的电动车头盔检测"))
        ...
        self.label_3.setText(_translate("MainWindow", "改进yolov8网络的电动车头盔检测"))
        # self.label_2.setText(_translate("MainWindow", "https://github.com/izhe666"))
        # 设置文本为HTML格式的链接
        self.label_2.setText(_translate("MainWindow",'<a href="https://github.com/izhe666">https://github.com/izhe666</a>'))
        # 启用外部链接打开功能
        self.label_2.setOpenExternalLinks(True)
        # 设置鼠标悬停时的光标样式
        self.label_2.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.label_12.setText(_translate("MainWindow", "izhe666"))
